...
当前版本达到“可交付候选版”标准：核心业务闭环、客户/项目隔离、四套官网模板、研究数据包、备份恢复、生产安全基础、Windows 交付包、10,000 篇官网容量和 30 分钟长稳均有通过证据。正式上线仍必须在客户 Linux/Docker 环境完成 TLS、域名、反向代理、模型/OCR 和真实发布渠道验收。因此建议为：**完成部署环境验收后上线**。
...
- 最新空白交付包：SHA-256 `279014cfbefab73c83249bdf2f81a64afe5a796bb61be5421796f47a966caf29`；不含客户数据和恢复密钥。
