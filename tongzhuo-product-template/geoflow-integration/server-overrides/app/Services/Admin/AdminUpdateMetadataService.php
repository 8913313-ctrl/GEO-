...
/**
 * Checks configured release metadata for admin update notifications.
 */
    ...
    public function buildNotificationPayload(): array
    {
        ...
        return [
            ...
            'links' => [
                ...
                'changelog' => [
                    'zh-CN' => (string) ($payload['changelog_url_zh'] ?? route('tongzhuo.insights')),
                    'en' => (string) ($payload['changelog_url_en'] ?? route('tongzhuo.insights')),
                ],
                'release' => (string) ($payload['release_url'] ?? url('/index.html')),
            ],
        ];
    }
