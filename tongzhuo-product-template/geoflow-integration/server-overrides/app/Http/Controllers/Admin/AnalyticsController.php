...
use App\Services\GeoGrowth\GeoAttributionService;
...
class AnalyticsController extends Controller
{
    public function __construct(
        ...
        private readonly GeoAttributionService $geoAttributionService,
    ) {}
    ...
    public function index(Request $request): View
    {
        ...
        return view('admin.analytics.index', [
            ...
            'geoAttribution' => $this->geoAttributionService->summary($filter),
        ]);
    }
