...
Route::prefix('v1')
    ...
    ->group(function (): void {
        ...
        Route::prefix('publisher')->group(function (): void {
            ...
            Route::get('devices/{device}/sessions', [PublisherDeviceController::class, 'sessions']);
            Route::post('devices/{device}/sessions', [PublisherDeviceController::class, 'session']);
