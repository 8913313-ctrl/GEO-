                ...
                <form method="POST" action="{{ route('admin.distribution.update', ['channelId' => (int) $channel->id]) }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input id="endpoint_url" name="endpoint_url" type="text" @if (! $channel->isLocalPublisher()) required @endif value="{{ old('endpoint_url', (string) $channel->endpoint_url) }}" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="{{ __('admin.distribution.placeholder.endpoint_url') }}">
                        ...
                        <div class="rounded-lg border border-blue-100 bg-blue-50 p-5">
                            ...
                            <div class="mt-6 grid grid-cols-1 gap-6 md:grid-cols-3">
                                ...
                                <div>
                                    ...
                                    <input id="wordpress_fixed_category" name="wordpress_fixed_category" type="text" value="{{ old('wordpress_fixed_category', $channelConfig['wordpress_fixed_category']) }}" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="1 鎴?News">
                                </div>
                                <div>
                    ...
                    @elseif ($channel->isLocalPublisher())
                        @include('admin.distribution._wechatsync-platforms', ['selectedPlatforms' => $wechatsyncConfig['wechatsync_platforms']])
                    @else
                    ...
                    <div class="rounded-lg border border-gray-200 bg-gray-50 p-5">
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input id="copyright_info" name="copyright_info" type="text" value="{{ old('copyright_info', $remoteSettings['copyright_info']) }}" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="漏 2026 Site Name">
                            </div>
                        </div>
