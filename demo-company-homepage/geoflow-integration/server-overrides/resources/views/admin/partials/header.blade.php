@php
    ...
    $menu = [
        ...
        'contact_leads' => ['route' => 'admin.contact-leads.index', 'name' => __('admin.nav.contact_leads')],
        'distribution' => ['route' => 'admin.distribution.index', 'name' => __('admin.nav.distribution')],
        'publisher_assistant' => ['route' => 'admin.publisher-assistant', 'name' => '发布助手'],
        'publisher_devices' => ['route' => 'admin.publisher-devices.index', 'name' => __('admin.nav.publisher_devices')],
    ...
    $subMap = [
        ...
        'admin.publisher-devices.index' => 'publisher_devices',
