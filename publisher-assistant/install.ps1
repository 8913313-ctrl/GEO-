...
if (-not (Test-Path $configPath)) {
    $config = @{ geoflowBaseUrl = $GeoFlowBaseUrl; apiToken = ''; port = $PublisherPort; pollSeconds = 20; extensionDir = $extensionDir; browserChannel = 'chromium'; browserHeadless = [bool]$BrowserHeadless; autoRun = $true; publishMode = 'publish' }
